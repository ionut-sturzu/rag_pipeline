...
variable "deploy_nim" {
  type        = bool
  default     = true
  description = "Controls the deployment of the NIM LLM helm chart."
}

variable "nim_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the NIM LLM helm chart defaults and those generated by Terraform using the templates."
}

variable "deploy_nim_nemo_embedder" {
  type        = bool
  default     = true
  description = "Controls the deployment of the NIM Nemo Embedder helm chart."
}

variable "nemo_embedder_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the NIM Nemo Embedder helm chart defaults and those generated by Terraform using the templates."
}
...
### NIM Nemo Embedder Values

variable "embedder_image_repository" {
  type        = string
  default     = "nvcr.io/nim/nvidia/nv-embedqa-e5-v5"
  description = "The NIM Nemo Embedder container image repository."
}

variable "embedder_image_tag" {
  type        = string
  default     = "1.0.1"
  description = "The NIM Nemo Embedder container image tag."
}